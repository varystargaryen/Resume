...
%---------------------------------------------------------
  \cventry
    {Digital Pathology Coordinator} % Job title
    {UC San Diego: School of Medicine - Department of Pathology} % Organization
    {La Jolla, CA} % Location
...
%---------------------------------------------------------
 \cventry
    ...
    {UC Irvine: Claire Trevor School of the Arts} % Organization
    {Irvine, CA} % Location
